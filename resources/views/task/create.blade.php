<x-task-layout>
    ...
    <div class="container my-5 ">
        <div class="text-box mb-3 d-flex justify-content-between  align-items-center">
            <h4 class="h4">Add Task / Create Todo</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('todo.store') }}" method="POST">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Task Name" name="name" class="form-control" value="{{old('name')}}">
                                @error('name') <span class="text-danger">{{$message}}</span> @enderror
                            </div>
                            <div>
                                <label for="" class="form-label mt-4">Work</label>
                                <input type="text" name="work" placeholder="Work" value="{{ old('work') }}" class="form-control">
